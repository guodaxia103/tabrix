...
- [TABRIX_TOOL_LAYERING_AND_RISK_CLASSIFICATION_zh.md](./TABRIX_TOOL_LAYERING_AND_RISK_CLASSIFICATION_zh.md)
...
这与当前公开技术原则保持一致，尤其是“真实浏览器优先、结构化输出优先、artifact 优先”的收口方向。
...
这与当前公开产品边界保持一致：主线聚焦真实 Chrome、MCP 和稳定执行，而不是继续扩大实验性能力面。

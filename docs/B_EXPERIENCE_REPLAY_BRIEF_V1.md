...
> **Status (this doc):** **v1 implemented in v2.4.0 (V24-01, 2026-04-22).** Owner decisions locked 2026-04-23 (now §10) shipped as-locked. Subsequent §10 follow-ups (`parent_step_id` cross-link, ranked-candidates fallback ladder, template-field capture-side write path) remain v2 scope and are deferred to V24-02 / V24-03. See `.claude/handoffs/v2_4_0_v24_01_experience_replay_v1.md` and the §12 reviewer checklist below for the landed deltas.

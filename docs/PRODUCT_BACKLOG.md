...
> Items `B-010`, `B-011`, `B-012`, `B-013`, `B-021`, `B-022` are landed (`B-011` v1 on 2026-04-22). The remaining pool items (`B-014`, `B-015`, `B-017` v2, `B-018` full Stage 3h, `B-019`, `B-020`, `B-024` follow-ups, plus the Stage 3a UI-Map-consumer cutover that `B-011` v1 deliberately did not do) feed Sprint 4 review.
>

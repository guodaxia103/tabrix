...
| B-018 | 3h    | K/E   | `tabrix_choose_context` MCP tool + seed decision table (v1 minimal slice done 2026-04-22; v1.5 telemetry + outcome write-back + markdown branch done 2026-04-22)                                                                                                                                       | L    | B-011 + B-013 + B-015 + B-017 in Beta |

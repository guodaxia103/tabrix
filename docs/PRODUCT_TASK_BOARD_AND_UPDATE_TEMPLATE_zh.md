...
本文档是 `PRODUCT_TASK_SYSTEM_AND_EXECUTION_QUEUE_zh.md` 的配套执行文档，用于解决两个实际问题：
...
4. `docs/CURRENT_CAPABILITIES_AND_BOUNDARIES_zh.md`
5. `docs/CODE_ENTRYPOINTS_AND_OWNERSHIP_zh.md`

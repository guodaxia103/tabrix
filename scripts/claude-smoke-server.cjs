...
<button id='promptBtn' onclick="document.getElementById('promptOut').textContent='pending';setTimeout(()=>{const v=prompt('Enter value','default');document.getElementById('promptOut').textContent=v||'';},300);">Prompt</button>

...
REM Windows: %LOCALAPPDATA%\tabrix\logs
set "LOG_DIR=%LOCALAPPDATA%\tabrix\logs"
...
if not defined NODE_EXEC (
    ...
    echo To fix: Set CHROME_MCP_NODE_PATH environment variable or run 'tabrix doctor --fix' >> "%WRAPPER_LOG%"
    exit /B 1
)

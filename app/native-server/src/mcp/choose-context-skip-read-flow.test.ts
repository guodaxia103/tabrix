  ...
  it('V27-P0-REAL closeout: API unavailable plus high-confidence visible rows returns dom_region_rows', async () => {
          ...
          rows: [
            {
              ...
              rowId: 'main_results_row_1',
              primaryText: 'Source One',
              secondaryText: null,
              summary: 'Source One | 10 likes',
              metaText: null,
              interactionText: '10 likes',
              visibleTextFields: ['First visible result', 'Source One', '10 likes'],
              targetRef: 'ref_result_1',
              targetRefCoverageRate: 0.99,
              boundingBox: { x: 300, y: 200, width: 200, height: 120 },
              regionId: 'main_results',
              sourceRegion: 'main_results',
              confidence: 0.82,
              qualityReasons: ['target_ref_available', 'visible_bounding_box'],
            },
            {
    ...
    expect(operationLog).toMatchObject({
      ...
      metadata: {
        ...
        targetRefCoverageRate: '0.99',
        regionQualityScore: '0.82',
        rejectedRegionReasonDistribution: '{"low_value_region":1,"footer_like_region":1}',
      },
    });
